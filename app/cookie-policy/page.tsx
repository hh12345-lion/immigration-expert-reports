    ...
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: June 2026" breadcrumbs={crumbs}>
        <p className="text-[#3A3F47] leading-relaxed">
          ...
          our{" "}
          <Link href="/privacy" className="font-semibold text-[#4F8FFF] hover:underline">
            Privacy Policy
          </Link>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Google Consent Mode</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-[8px] border border-[#C5CAD1] bg-[#DEE2E6] p-4">
                <h3 className="font-semibold text-[#0C0E12]">{meta.label}</h3>
                <p className="mt-2 text-sm text-[#3A3F47]">{meta.description}</p>
                {meta.required && (
                  <p className="mt-2 text-xs font-medium uppercase tracking-wide text-[#4F8FFF]">
                    Always active
                  </p>
                )}
              </section>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Third-party services</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <p className="mt-4 text-sm text-[#3A3F47]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Your choices</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">California residents (CCPA)</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Browser controls</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Contact</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
          Questions about cookies:{" "}
          <a href={`mailto:${SITE_EMAIL}`} className="font-semibold text-[#4F8FFF] hover:underline">
            {SITE_EMAIL}
          </a>
        </p>
      </PageShell>
