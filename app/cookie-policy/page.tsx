    ...
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: June 2026" breadcrumbs={crumbs}>
        <p className="text-[#374151] leading-relaxed">
          ...
          our{" "}
          <Link href="/privacy" className="font-semibold text-[#0E7490] hover:underline">
            Privacy Policy
          </Link>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Google Consent Mode</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-[8px] border border-[#CBD5E1] bg-[#F8FAFC] p-4">
                <h3 className="font-semibold text-[#1E3A5F]">{meta.label}</h3>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Third-party services</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Your choices</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">California residents (CCPA)</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Browser controls</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Contact</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
          Questions about cookies:{" "}
          <a href={`mailto:${SITE_EMAIL}`} className="font-semibold text-[#0E7490] hover:underline">
            {SITE_EMAIL}
          </a>
        </p>
      </PageShell>
