...
export const metadata = createMetadata({
  title: "Cookie Policy | Immigration Expert Reports",
  description:
    "How ImmigrationExpertReports.com uses cookies and similar technologies, your choices under UK GDPR and ePrivacy, and how to manage preferences.",
  path: "/cookie-policy",
  noindex: true,
  follow: true,
});
    ...
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: June 2026" breadcrumbs={crumbs}>
        <p className="text-[#3E4450] leading-relaxed">
          This Cookie Policy explains how ImmigrationExpertReports.com (&quot;we&quot;, &quot;us&quot;)
          uses cookies and similar technologies when you visit our website. It should be read alongside
          our{" "}
          <Link href="/privacy" className="font-semibold text-[#2557D6] hover:underline">
            Privacy Policy
          </Link>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Google Consent Mode</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-[8px] border border-[#DDD6CB] bg-[#EBE6DC] p-4">
                <h3 className="font-semibold text-[#1B2430]">{meta.label}</h3>
                <p className="mt-2 text-sm text-[#3E4450]">{meta.description}</p>
                {meta.required && (
                  <p className="mt-2 text-xs font-medium uppercase tracking-wide text-[#2557D6]">
                    Always active
                  </p>
                )}
              </section>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Third-party services</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
        ...
        <p className="mt-4 text-sm text-[#3E4450]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Your choices</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">California residents (CCPA)</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Browser controls</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2430]">Contact</h2>
        <p className="mt-4 text-[#3E4450] leading-relaxed">
          Questions about cookies:{" "}
          <a href={`mailto:${SITE_EMAIL}`} className="font-semibold text-[#2557D6] hover:underline">
            {SITE_EMAIL}
          </a>
        </p>
      </PageShell>
