  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">The Expert&apos;s Duty to the Tribunal</h2>
        ...
        <h2 id="report-standards" className="mt-10 text-xl font-bold text-[#0C0E12]">
          ...
          <table className="w-full min-w-[640px] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[#C5CAD1] bg-[#DEE2E6]">
                <th className="p-3 font-semibold text-[#0C0E12]">Requirement</th>
                <th className="p-3 font-semibold text-[#0C0E12]">Source</th>
                <th className="p-3 font-semibold text-[#0C0E12]">2025–2026 Update</th>
              </tr>
            </thead>
            <tbody>
              {standardsTable.map((row) => (
                <tr key={row.requirement} className="border-b border-[#C5CAD1]">
                  <td className="p-3 text-[#3A3F47]">{row.requirement}</td>
                  <td className="p-3 text-[#3A3F47]">{row.source}</td>
                  <td className="p-3 text-[#3A3F47]">{row.update}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Adam Pipe October 2025 Guide</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <ol className="mt-4 list-decimal space-y-2 pl-6 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">What a Compliant Report Should Contain</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Single Joint Experts and Hot-Tubbing</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0C0E12]">Choosing the Right Report Type</h2>
        <p className="mt-4 text-[#3A3F47] leading-relaxed">
          ...
          <Link href="/report-types" className="text-[#4F8FFF] hover:underline">
            report types hub
          </Link>{" "}
          and{" "}
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link href="/guides/immigration-expert-report-standards-guide" className="font-semibold text-[#4F8FFF] hover:underline">
