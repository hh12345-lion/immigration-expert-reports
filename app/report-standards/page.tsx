  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">The Expert&apos;s Duty to the Tribunal</h2>
        ...
        <h2 id="report-standards" className="mt-10 text-xl font-bold text-[#1E3A5F]">
          ...
          <table className="w-full min-w-[640px] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[#CBD5E1] bg-[#F8FAFC]">
                <th className="p-3 font-semibold text-[#1E3A5F]">Requirement</th>
                <th className="p-3 font-semibold text-[#1E3A5F]">Source</th>
                <th className="p-3 font-semibold text-[#1E3A5F]">2025–2026 Update</th>
              </tr>
            </thead>
            <tbody>
              {standardsTable.map((row) => (
                <tr key={row.requirement} className="border-b border-[#CBD5E1]">
                  <td className="p-3 text-[#374151]">{row.requirement}</td>
                  <td className="p-3 text-[#374151]">{row.source}</td>
                  <td className="p-3 text-[#374151]">{row.update}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Adam Pipe October 2025 Guide</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">What a Compliant Report Should Contain</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Single Joint Experts and Hot-Tubbing</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1E3A5F]">Choosing the Right Report Type</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
          ...
          <Link href="/report-types" className="text-[#0E7490] hover:underline">
            report types hub
          </Link>{" "}
          and{" "}
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link href="/guides/immigration-expert-report-standards-guide" className="font-semibold text-[#B8860B] hover:underline">
