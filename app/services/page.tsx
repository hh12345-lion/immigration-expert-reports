  ...
  return (
    <>
      ...
      <PageShell
        ...
        subtitle="Eight core services across our network — from country condition reports to oral evidence at tribunal."
        breadcrumbs={crumbs}
      >
        <p className="mb-8 text-[#374151] leading-relaxed">
          ...
          . Report standards and tribunal compliance apply across all services.
        </p>
        <CardGrid
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link href="/fees" className="font-semibold text-[#B8860B] hover:underline">
            Fees & Legal Aid
          </Link>
        </div>
      </PageShell>
