...
export const APP_STATIC_PATHS: PublicUrlEntry[] = [
  ...
  { path: "/report-standards", priority: 0.95, changefreq: "monthly" },
  { path: "/report-types", priority: 0.93, changefreq: "monthly" },
  { path: "/network", priority: 0.93, changefreq: "monthly" },
  { path: "/tribunal-process", priority: 0.9, changefreq: "monthly" },
  { path: "/cpin-and-country-guidance", priority: 0.9, changefreq: "monthly" },
  { path: "/services", priority: 0.9, changefreq: "monthly" },
  { path: "/what-is-an-immigration-expert-report", priority: 0.9, changefreq: "monthly" },
...
function dynamicEntries(): PublicUrlEntry[] {
  return [
    ...reportTypes.map((r) => ({
      path: `/report-types/${r.slug}`,
      priority: 0.92,
      changefreq: "monthly" as const,
    })),
    ...tribunalProcesses.map((t) => ({
      path: `/tribunal-process/${t.slug}`,
      priority: 0.9,
      changefreq: "monthly" as const,
    })),
    ...caseTypes.map((c) => ({
