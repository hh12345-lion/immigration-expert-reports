  ...
  return [
    {
      ...
      load: () => {
        ...
        injectScript("ier-gtag-js", `https://www.googletagmanager.com/gtag/js?id=${gaId}`);
        const inline = document.createElement("script");
        inline.id = "ier-gtag-inline";
        inline.textContent = `
      ...
      unload: () => {
        removeScript("ier-gtag-js");
        removeInlineScript("ier-gtag-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("ier-gtm-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("ier-meta-pixel");
    ...
    },
    {
      ...
      load: () => {
        ...
        const inline = document.createElement("script");
        inline.id = "ier-linkedin-insight";
        inline.textContent = `
      ...
      unload: () => {
        removeInlineScript("ier-linkedin-insight");
        removeScript("ier-linkedin-js");
